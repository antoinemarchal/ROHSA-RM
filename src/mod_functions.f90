...
module mod_functions
  ...
  public :: mean_array, mean_map, dim2nside, dim_data2dim_cube, reshape_up, reshape_down, go_up_level, init_spectrum, &
       update, set_stdmap, std_spectrum, mean_spectrum, max_spectrum, init_grid_params, reshape_noise_up, init_spectrum_new
...
contains
  ...
  subroutine init_spectrum_new(pars, line, dim_v)
    ...
    call init_bounds(lb, ub, params%n)
    ...
    call minimize_spec(2*params%n, params%m, x, lb, ub, line, dim_v, params%maxiter_init, params%iprint_init, params%n)
    ...
    deallocate(x)
    deallocate(lb, ub)
  end subroutine init_spectrum_new
