...
module mod_optimize
  ...
  public :: myfunc_spec, f_g_cube_fast_nopow, myresidual, mygrad_spec
...
contains
  ...
  subroutine f_g_cube_fast_nopow(f, g, cube, beta, dim_v, dim_y, dim_x, kernel, std_map)
    implicit none
    ...
    do j=1, dim_x
       do i=1, dim_y
          ...
          residual_1D = 0._xp
          call myresidual(pars(:,i,j), cube(:,i,j), residual_1D, dim_v, params%n)
